...
@section('content')
    <section class="portfolio wow swing" id="portfolio">
        <div class="container">
            ...
            <div class="row mt-2 filter-sections">
                ...
                <?php for ($i=1;$i<=84;$i++){?>
                    <div class="col-lg-4 mt-4 float-left col-md-12 col-xs-12 item-filter playful scrollbar style-2 rekazfuel">
                        <figure class="softeffect">
                            <img src="{{asset('imgs/portfolio/rekazfuel/'.$i.'.png')}}" class="img-responsive lazy img-item-filter"   />
                            <figcaption>
                                <h4><a data-fancybox="gallery-rekazfuel"   href="{{asset('imgs/portfolio/rekazfuel/'.$i.'.png')}}"><i class="fas fa-eye"></i></a></h4>
                                <p  data-toggle="modal" data-target="#Modal_rekazfuel_<?php echo $i;?>">More Details</p>
                            </figcaption>
                        </figure>
                    </div>
                <?php }?>
    ...
    <?php for ($i=1;$i<=84;$i++){?>
        <div class="modal fade" id="Modal_rekazfuel_<?php echo $i;?>" tabindex="-1" role="dialog" aria-labelledby="Modal_rekazfuel_<?php echo $i;?>" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">rekazfuel rekazfuel Website</h5>
                    </div>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-6 project-details">
                                    ...
                                    <ul class="ul-project-describe">
                                        <li><span class="project-info-head">Client : </span>rekazfuel rekazfuel Company</li>
