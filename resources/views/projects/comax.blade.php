                ...
                <?php for ($i=1;$i<=4;$i++){?>
                    <div class="col-lg-4 mt-4 float-left col-md-12 col-xs-12 item-filter playful scrollbar style-2 comax">
                        <figure class="softeffect">
                            <img src="{{asset('imgs/portfolio/comax/'.$i.'.png')}}" class="img-responsive lazy img-item-filter"   />
                            <figcaption>
                                <h4><a data-fancybox="gallery-comax"   href="{{asset('imgs/portfolio/comax/'.$i.'.png')}}"><i class="fas fa-eye"></i></a></h4>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Comax  Group Website</h5>
                    </div>
