...
@section('content')
    <section class="portfolio wow swing" id="portfolio">
        <div class="container">
            ...
            <div class="row mt-2 filter-sections">
                ...
                <?php for ($i=1;$i<=8;$i++){?>
                    <div class="col-lg-4 mt-4 float-left col-md-12 col-xs-12 item-filter playful scrollbar style-2 rekazb">
                        <figure class="softeffect">
                            <img src="{{asset('imgs/portfolio/rekazb/'.$i.'.png')}}" class="img-responsive lazy img-item-filter"   />
                            <figcaption>
                                <h4><a data-fancybox="gallery-rekazb"   href="{{asset('imgs/portfolio/rekazb/'.$i.'.png')}}"><i class="fas fa-eye"></i></a></h4>
                                <p  data-toggle="modal" data-target="#Modal_rekazb_<?php echo $i;?>">More Details</p>
                            </figcaption>
                        </figure>
                    </div>
                <?php }?>
    ...
    <?php for ($i=1;$i<=8;$i++){?>
        <div class="modal fade" id="Modal_rekazb_<?php echo $i;?>" tabindex="-1" role="dialog" aria-labelledby="Modal_rekazb_<?php echo $i;?>" aria-hidden="true">
