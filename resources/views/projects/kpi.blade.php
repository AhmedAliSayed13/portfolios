                ...
                <?php for ($i=1;$i<=12;$i++){?>
                    <div class="col-lg-4 mt-4 float-left col-md-12 col-xs-12 item-filter playful scrollbar style-2 kpi">
                        <figure class="softeffect">
                            <img src="{{asset('imgs/portfolio/kpi/'.$i.'.png')}}" class="img-responsive lazy img-item-filter"   />
                            <figcaption>
                                <h4><a data-fancybox="gallery-kpi"   href="{{asset('imgs/portfolio/kpi/'.$i.'.png')}}"><i class="fas fa-eye"></i></a></h4>
