                ...
                <?php for ($i=1;$i<=56;$i++){?>
                    <div class="col-lg-4 mt-4 float-left col-md-12 col-xs-12 item-filter playful scrollbar style-2 school">
                        <figure class="softeffect">
                            ...
                            <figcaption>
                                <h4><a data-fancybox="gallery-school"   href="{{asset('imgs/portfolio/school/'.$i.'.png')}}"><i class="fas fa-eye"></i></a></h4>
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-6 project-details">
                                    ...
                                    <a href="http://34.125.4.18/erp/login" class="btn btn-info"><i class="fa fa-globe"></i> WebSite</a>
