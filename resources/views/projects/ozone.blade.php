...
@section('content')
            ...
            <div class="row mt-2 filter-sections">
                ...
                <div class="col-lg-4 mt-4 float-left col-md-12 col-xs-12 item-filter playful scrollbar style-2 ozone">
                    <figure class="softeffect">
                        <img src="{{ asset('imgs/portfolio/ozone/' . $i . '.png') }}"
                            class="img-responsive lazy img-item-filter" />
                        <figcaption>
                            <h4><a data-fancybox="gallery-ozone" href="{{ asset('imgs/portfolio/ozone/' . $i . '.png') }}"><i
    ...
    <?php for ($i=1;$i<=34;$i++){?>
    <div class="modal fade" id="Modal_ozone_<?php echo $i; ?>" tabindex="-1" role="dialog"
        aria-labelledby="Modal_ozone_<?php echo $i; ?>" aria-hidden="true">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-6 project-details">
                                ...
                                <a href="https://ozone.social/" class="btn btn-info"><i class="fa fa-globe"></i>
                                    WebSite</a>
                                <a class="btn btn-info" href="Ahmed-Ali-CV.pdf" target="_blank"><i
                                        class="fas fa-eye"></i> Ahmed Ali CV</a>
