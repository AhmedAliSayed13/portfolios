        ...
        <div class="skills">
            ...
            <div class="row">
                <div class="col-md-12 col-xs-12">
                    ...
                    <div class="col-lg-3 float-left text-center ">
                        <div class="skill-item">
                            <img src="{{asset('')}}imgs/skills/Fat_Free.png" width="220px">
                    ...
                    <div class="col-lg-3 float-left text-center ">
                        <div class="skill-item">
                            <i class="devicon-composer-line colored font-icon"></i>
                            <h2 class="item-precentage"><span class="counter"> 80 </span><span>%</span></h2>
                            <p class="item-title">Composer</p>
                        </div>
                    </div>
                    <div class="col-lg-3 float-left text-center ">
                        <div class="skill-item">
                            <i class="devicon-postgresql-plain colored font-icon"></i>
                            <h2 class="item-precentage"><span class="counter"> 80 </span><span>%</span></h2>
                            <p class="item-title">Postgresql</p>
                        </div>
                    </div>
                    <div class="col-lg-3 float-left text-center ">
                        <div class="skill-item">
                            <i class="devicon-angularjs-plain colored font-icon"></i>
                            <h2 class="item-precentage"><span class="counter"> 85 </span><span>%</span></h2>
                            <p class="item-title">Angular</p>
                        </div>
                    </div>
                    <div class="col-lg-3 float-left text-center ">
                        <div class="skill-item">
                            <img src="{{asset('imgs/skills/responsive.png')}}" width="110px">
                            <h2 class="item-precentage"><span class="counter"> 85 </span><span>%</span></h2>
                    ...
                    <div class="col-lg-3 float-left text-center ">
                        <div class="skill-item">
                            <i class="devicon-xml-plain colored font-icon"></i>
                            <h2 class="item-precentage"><span class="counter"> 90 </span><span>%</span></h2>
                            <p class="item-title">XML</p>
                        </div>
                    </div>
                    <div class="col-lg-3 float-left text-center ">
                        <div class="skill-item">
                            <img src="{{asset('imgs/skills/google-ads.jpg')}}" width="100px">
                            <h2 class="item-precentage"><span class="counter"> 70 </span><span>%</span></h2>
                            <p class="item-title">Google Ads</p>
                        </div>
                    </div>
